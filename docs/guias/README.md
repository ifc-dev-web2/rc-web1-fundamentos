...
Este diretório reúne os guias complementares utilizados na disciplina de **Desenvolvimento Web I**.

Os materiais foram organizados para auxiliar na revisão dos conceitos apresentados em aula e servir como referência durante o desenvolvimento das atividades e dos projetos.

> Os guias não substituem as explicações, demonstrações e atividades realizadas em sala. Utilize-os para revisar conceitos, consultar exemplos e esclarecer dúvidas durante o desenvolvimento.
...
Apresenta os arquivos e as configurações utilizados para manter a formatação do código consistente entre os projetos.
...
Explica como o navegador calcula o espaço ocupado por cada elemento da página.
...
Apresenta o funcionamento do Flexbox e sua utilização na construção de layouts.
...
Apresenta boas práticas para inserir, organizar e adaptar imagens dentro das páginas.
...
Apresenta os principais conceitos relacionados à organização visual dos textos.
...
Apresenta uma sequência de investigação para identificar e corrigir problemas de layout e estilização utilizando as ferramentas do navegador.
...
Essa sequência é apenas uma recomendação. Os guias também podem ser consultados individualmente conforme a necessidade encontrada durante o desenvolvimento.
...
Evite apenas copiar os exemplos. Procure compreender a função de cada elemento e propriedade antes de incorporá-los ao projeto.
